...
namespace Services.PathHelper
{
    ...
    {
        public static string _Json_To(MF_PathHelper_Path P_MF_PathHelper)
        {
            return Newtonsoft.Json.JsonConvert.SerializeObject(P_MF_PathHelper);
        }

        public static MF_PathHelper_Path _Json_From(string P_MF_PathHelper)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MF_PathHelper_Path>(P_MF_PathHelper);
        }
