...
namespace Web
{
    public partial class HTML_Templates
    {
        private HTML_Object _Template_ThemeModal_Body_Footer()
        {
            ...
            L_HTML_Object.Add_Child(_Template_ThemeModal_Body_Footer_ResetThemeBtn());
        ...
        private HTML_Object _Template_ThemeModal_Body_Footer_ResetThemeBtn()
        {
            HTML_Object L_HTML_Object = _Template_Button("Btn_ThemeReset", "Reset");


            L_HTML_Object.Add_Attribute("onclick", "_App_ThemeReset('" + Web_InterCommMessage_Type.Theme_Reset + "')");
